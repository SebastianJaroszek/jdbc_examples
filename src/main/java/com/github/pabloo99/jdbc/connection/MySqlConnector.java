    ...
    public static Connection getMySqlConnection(){
        ...
        try {
            return DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/hr?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&useSSL=false", "root", "940647xd");
